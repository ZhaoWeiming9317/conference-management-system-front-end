export const navList = [
    ...
    {'label': '会议管理', 'key': 2, 'linkTo': '/meeting', 'type': "team", 'role':1},
    {'label': '用户管理', 'key': 3, 'linkTo': '/user', 'type': "user"  ,'role':1},
    {'label': '会议室管理', 'key': 4, 'linkTo': '/room', 'type': "home"   ,'role':1},
    {'label': '设备管理', 'key': 5, 'linkTo': '/device', 'type': "desktop"   ,'role':1},
